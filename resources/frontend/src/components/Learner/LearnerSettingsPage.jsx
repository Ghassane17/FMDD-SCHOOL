...
import CertificationsForm from "../formateurs/profile-completion-formateur/CertificationsForm";
import {
  Box,
  Typography,
  Paper,
...
export default function LearnerSettingsPage({ backend_url }) {
  ...
  if (loading) {
    return (
      <Container maxWidth="xl" sx={{ py: 4, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <CircularProgress />
      </Container>
    );
  }
