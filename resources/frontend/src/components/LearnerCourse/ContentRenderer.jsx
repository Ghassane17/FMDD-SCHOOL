 ...
 */
const ContentRenderer = ({ type, textContent, filePath, quizQuestions = [], resources = [] }) => {
    ...
    const renderContent = () => {
        switch (type) {
            ...
            case 'pdf':
                return (
                    <div className="w-full h-[600px]">
                        <iframe
                            src={filePath || (resources.find((r) => r.type === 'pdf')?.url)}
            ...
            case 'image':
                return (
                    <div className="flex justify-center">
                        <img
                            src={filePath || (resources.find((r) => r.type === 'image')?.url)}
                            alt="Module content"
            ...
            case 'video':
                return videoResource || filePath ? (
                    <VideoPlayer url={videoResource?.url || filePath} />
                ) : (
                    <div>No video available for this module.</div>
                );
