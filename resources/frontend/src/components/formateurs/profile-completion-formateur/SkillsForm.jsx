...
const SkillsForm = ({ data, updateData }) => {
  ...
  const suggestedSkills = [
    ...
    "TypeScript", "Node.js", "Vue.js", "Angular", "PHP",
    "Ruby", "Java", "C#", "DevOps", "Cloud Computing"
  ].filter(skill => !data.includes(skill));

  return (
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
        <h3 className="text-3xl font-bold mb-5 text-gray-800">Quels sont vos domaines d'expertise ?</h3>
        <p className="text-xl text-gray-600 mb-8">
          Ajoutez vos compétences pour aider les étudiants à trouver vos cours.
        </p>
        ...
        {data.length > 0 && (
          <div className="mb-10">
            <Label className="mb-4 block text-xl font-medium">Vos compétences</Label>
        ...
        {suggestedSkills.length > 0 && (
          <div>
            <Label className="mb-4 block text-xl font-medium">Compétences suggérées</Label>
            <div className="flex flex-wrap gap-4">
