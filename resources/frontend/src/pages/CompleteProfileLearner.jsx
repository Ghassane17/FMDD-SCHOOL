...
import FieldsOfInterestForm from "../components/Learner/profile-completion-learner/FieldsOfInterestForm";
...
import BankInfoForm  from "@/components/formateurs/profile-completion-formateur/BankInfoForm.jsx";
...
const CompleteProfileInstructor = () => {
    ...
    const updateSkills = (fields_of_interest) => {
        setFormData(prev => ({ ...prev, fields_of_interest }));
    };
    ...
    const renderStepContent = () => {
        switch (currentStep) {
            case 1:
                return <FieldsOfInterestForm data={formData.fields_of_interest} updateData={updateSkills} />;
            case 2:
